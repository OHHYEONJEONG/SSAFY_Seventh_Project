...
export default {
  ...
  methods: {
    updateBoard() {
      ...
      if (this.interest_area == '') {
        alert('관심 지역을 작성하세요.');
        return;
      }
      if (this.marriage_type == '') {
        alert('결혼 여부을 작성하세요.');
        return;
      } else {
        this.$router.push('/');
    ...
    newCustomer() {
      (this.submitted = false),
        ...
        (this.userpwd = null),
        (this.username = null),
        (this.contemailent = null),
        (this.address = null),
        (this.yy = null),
        (this.mm = null),
        (this.dd = null),
        (this.interest_area = null),
        (this.marriage_type = null);
    },
  },
};
</script>
